...
| <p><code></code><br><code>dart pub global activate onepub</code></p><p><code>onepub login</code></p><p><code>cd &#x3C;my project></code></p><p><code>onepub private</code></p><p>dart pub publish</p><p></p> | ![](<.gitbook/assets/OnePub.dev Logo – reversed FA (1).svg>) |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ |
