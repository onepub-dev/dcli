...
class Acfcbcaeaaeecaefc extends PackedResource {
  /// PackedResource - ../../template/basic/analysis_options.yaml
  const Acfcbcaeaaeecaefc();
  ...
  @override
  String get originalPath => 'template/basic/analysis_options.yaml';
